...
if(isset($_POST['submit']))
  {
    $staffid=$_SESSION['fosaid'];
    $staffname=$_POST['staffname'];
    $mobno=$_POST['mobilenumber'];
    $email=$_POST['email'];
  
  
     $query=mysqli_query($con, "update tblstaff set StaffName ='$staffname', MobileNumber='$mobno', Email='$email' where ID='$staffid'");
    if ($query) {
                            ...
                            <form id="submit" action="#" class="wizard-big" method="post" name="submit">
                                    <fieldset>
                                          <div class="form-group row"><label class="col-sm-2 col-form-label">Staff Name:</label>
                                                <div class="col-sm-10"><input name='staffname' id="staffname" class="form-control white_bg" value="<?php  echo $row['StaffName'];?>">
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Staff Registration date:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="staffrd" readonly="true" value="<?php  echo $row['StaffRegDate'];?>"></div>
                                            </div>
