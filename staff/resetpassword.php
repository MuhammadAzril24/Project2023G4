...
if(isset($_POST['submit']))
  {
    ...
    $password=md5($_POST['newpassword']);
        ...
        $query=mysqli_query($con,"update tblstaff set Password='$password'  where  Email='$email' && MobileNumber='$contactno' ");
   if($query)
   {
...
<head>
    ...
    <title>Meathos| Reset Password</title>
...
<body class="gray-bg">
    ...
    <div class="loginColumns animated fadeInDown">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 class="font-bold">Meathos Restaurant | Staff Reset Password</h2>
