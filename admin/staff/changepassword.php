...
$query=mysqli_query($con,"select ID from tblstaff where ID='$staffid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tblstaff set Password='$newpassword' where ID='$staffid'");
